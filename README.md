...
<p>Fixed</p>
<ul>
    <li><strong>Formatting:</strong> Although all the characters were working, the layout of the board was broken when using an f-string to format it. Using formatting placeholders may not actually be the optimal approach but were the best resolution at the time of submission. This should be reviewed in future iterations.</li>
